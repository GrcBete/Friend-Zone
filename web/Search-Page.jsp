    ...
    <body>
        ...
        <div class="Home-Page">
            ...
            <div class="Menu">
                ...
                <%
                String mysql1 = "Select Person_Id, Full_Name from Reg_Table where Person_Id = "+pidS+" order by Full_Name asc";
                ...
                if (result1.next()){
                    String person_id = result1.getString(1);
                ...
                <%session.setAttribute("PersonId_Search", person_id);
                    }
